...
// app.use(cors());
app.use(cors({
  origin: ['http://localhost:8080', 'http://localhost:3000', 'https://tech-zone-navy.vercel.app', 'https://www.apexteks.com'], // Replace this with the origin of your frontend application
